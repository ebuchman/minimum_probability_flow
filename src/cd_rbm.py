...
def test_rbm(datasets, learning_rate=0.1, training_epochs=15, batch_size=20, \
             ...
             n_hidden=500, nvisible=10, k=1):

    train_set_x  = datasets
    test_set_x = datasets #hack
    ...
    rbm = RBM(input=x, n_visible=nvisible, \
    ...
    return rbm.W.get_value(), rbm.hbias.get_value(), rbm.vbias.get_value(), end_time-start_time
